...
{
    public partial class dilEkle : Form
    {
        public dilEkle()
        {
            InitializeComponent();
        ...
        private void dilEkle_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string query = "INSERT INTO BSMSMEGEN002 (COMCODE, LANCODE, LANTEXT) VALUES (@FirmaKodu, @DilKodu, @DilAdı)";
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                try
                {
                    ...
                    using (SqlCommand command = new SqlCommand(query, connection))
                    {
                        ...
                        command.Parameters.AddWithValue("@DilAdı", dil_adi_txt.Text);
