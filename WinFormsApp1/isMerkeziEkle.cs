...
{
    public partial class isMerkeziEkle : Form
    {
        public isMerkeziEkle()
        {
            InitializeComponent();
        }

        private void isMerkeziEkle_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string query = "INSERT INTO BSMSMEWCM001 (COMCODE, DOCTYPE, DOCTYPETEXT,ISPASSIVE) VALUES (@FirmaKodu, @IsMerkeziTipiKodu, @IsMerkeziTipiAdı, @Pasif)";
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                try
                {
                    ...
                    using (SqlCommand command = new SqlCommand(query, connection))
                    {
                        ...
                        command.Parameters.AddWithValue("@IsMerkeziTipiKodu", is_merkezi_tipi_txt.Text);
                        command.Parameters.AddWithValue("@IsMerkeziTipiAdı", is_merkezi_aciklamasi.Text);
