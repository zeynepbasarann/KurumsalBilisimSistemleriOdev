...
{
    public partial class malzemeTipiEkle : Form
    {
        public malzemeTipiEkle()
        {
            InitializeComponent();
        }

        private void malzemeTipiEkle_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string query = "INSERT INTO BSMSMEMAT001 (COMCODE, DOCTYPE, DOCTYPETEXT,ISPASSIVE) VALUES (@FirmaKodu, @MalzemeTipiKodu, @MalzemeTipiAdı, @Pasif)";
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                try
                {
                    ...
                    using (SqlCommand command = new SqlCommand(query, connection))
                    {
                        ...
                        command.Parameters.AddWithValue("@MalzemeTipiKodu", malzeme_tipi_txt.Text);
                        command.Parameters.AddWithValue("@MalzemeTipiAdı", malzeme_aciklamasi_txt.Text);
