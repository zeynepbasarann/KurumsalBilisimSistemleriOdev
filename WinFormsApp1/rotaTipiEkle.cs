...
{
    public partial class rotaTipiEkle : Form
    {
        public rotaTipiEkle()
        {
            InitializeComponent();
        ...
        private void rotaTipiEkle_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string query = "INSERT INTO BSMSMEROT001 (COMCODE, DOCTYPE, DOCTYPETEXT,ISPASSIVE) VALUES (@FirmaKodu, @RotaTipiKodu, @RotaTipiAdı, @Pasif)";
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                try
                {
                    ...
                    using (SqlCommand command = new SqlCommand(query, connection))
                    {
                        ...
                        command.Parameters.AddWithValue("@RotaTipiKodu", rota_tipi_txt.Text);
                        command.Parameters.AddWithValue("@RotaTipiAdı", rota_aciklamasi_txt.Text);
