...
{
    public partial class maliyetMerkeziEkle : Form
    {
        public maliyetMerkeziEkle()
        {
            InitializeComponent();
        }

        private void maliyetMerkeziEkle_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string query = "INSERT INTO BSMSMECCM001 (COMCODE, DOCTYPE, DOCTYPETEXT,ISPASSIVE) VALUES (@FirmaKodu, @MaliyetMerkeziKodu, @MaliyetMerkeziAdı, @Pasif)";
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                try
                {
                    ...
                    using (SqlCommand command = new SqlCommand(query, connection))
                    {
                        ...
                        command.Parameters.AddWithValue("@MaliyetMerkeziKodu", maliyet_merkezi_kodu_txt.Text);
                        command.Parameters.AddWithValue("@MaliyetMerkeziAdı", maliyet_merkezi_aciklamasi_txt.Text);
